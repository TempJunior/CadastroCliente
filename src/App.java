    ...
    public static void main(String args []){
        ...
        while (!isOpcaoValida(opcao)){
            ...
            opcao = JOptionPane.showInputDialog(null,
                    "Opcão invalida. Digite 1 para cadastro, 2 para consulta, 3 para exclusão, 4 para alteração ou 5 para sair.",
                    "Cadastro", JOptionPane.INFORMATION_MESSAGE);
        }
        ...
        while (isOpcaoValida(opcao)){
            ...
            String dados = JOptionPane.showInputDialog(null,
                    "Digite os dados do cliente separados por virgula: Nome, Cpf, telefone, Endereço, Numero, Cidade e Estado",
                    "Cadastro", JOptionPane.INFORMATION_MESSAGE);
            cadastrar (dados);
